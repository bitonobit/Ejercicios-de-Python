# Revisa todas las URLs de un sitio en busca de emails y los guarda en un archivo de contactos .txt
import requests
...
def obtener_urls(sitio_web):
    urls = set()  # Utilizamos un conjunto para evitar duplicados
    # Hacemos una solicitud HTTP para obtener el contenido HTML del sitio web
    respuesta = requests.get("https://youtube.com/@HolaMundoDev/videos")
